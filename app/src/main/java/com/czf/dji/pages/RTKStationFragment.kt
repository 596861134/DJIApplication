...
import com.czf.dji.data.RtkStationScanAdapter
import com.czf.dji.databinding.FragStationRtkPageBinding
import com.czf.dji.models.RTKStationVM
...
class RTKStationFragment : DJIFragment(), RtkStationScanAdapter.OnItemClickListener {
    ...
    private lateinit var binding: FragStationRtkPageBinding
    ...
    private fun DJIRTKBaseStationConnectInfo.refresh(connectState: RTKStationConnetState?) {
        connectState?.let {
            LogUtils.i(com.czf.dji.pages.RTKStationFragment.TAG, "connectState=$connectState")

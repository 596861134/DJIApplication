...
import com.czf.dji.data.DEFAULT_STR
import com.czf.dji.databinding.VideoChannelPageBinding
import com.czf.dji.models.MultiVideoChannelVM
import com.czf.dji.models.VideoChannelVM
import com.czf.dji.models.VideoChannelVMFactory
...
class VideoChannelFragment : DJIFragment(), View.OnClickListener, SurfaceHolder.Callback,
    ...
    private lateinit var binding: VideoChannelPageBinding
    ...
    private fun handlerYUV() {
        if (!binding.horizontalScrollView.yuvScreenShot.isSelected) {

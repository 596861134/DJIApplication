...
import com.czf.dji.databinding.FragLoginAccountPageBinding
import com.czf.dji.models.LoginVM
...
class LoginFragment : DJIFragment() {
    ...
    private lateinit var binding: FragLoginAccountPageBinding
    ...
    private fun showVerificationCodeImage() {
        AndroidSchedulers.mainThread().scheduleDirect {
            ...
            Glide.with(requireActivity())
                ...
                .into(binding.ivVerificationCodeImageInfo)
        }
    }

...
import com.czf.dji.databinding.FragmentCameraStreamDetailBinding
import com.czf.dji.databinding.FragmentCameraStreamDetailSingleBinding
import com.czf.dji.models.CameraStreamDetailVM
...
class CameraStreamDetailFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = if (onlyOneCamera) {
            FragmentCameraStreamDetailSingleBinding.inflate(inflater, container, false)
        } else {
            FragmentCameraStreamDetailBinding.inflate(inflater, container, false)
        }
        return binding.root
    }
    ...
    private fun updateCameraStream() {
        if (isNeedPreviewCamera) {
            if (onlyOneCamera) {
                // 针对单摄像头的逻辑
                (binding as FragmentCameraStreamDetailSingleBinding).svCamera.visibility = View.VISIBLE
            } else {
                // 针对多摄像头的逻辑
                (binding as FragmentCameraStreamDetailBinding).svCamera.visibility = View.VISIBLE
            }
        } else {
            if (onlyOneCamera) {
                // 针对单摄像头的逻辑
                (binding as FragmentCameraStreamDetailSingleBinding).svCamera.visibility = View.GONE
            } else {
                // 针对多摄像头的逻辑
                (binding as FragmentCameraStreamDetailBinding).svCamera.visibility = View.GONE
            }
        }

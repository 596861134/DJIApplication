...
import com.czf.dji.data.DeviceLockStatus
import com.czf.dji.data.ModifyPasswordBean
import com.czf.dji.databinding.FragSecurityCodePageBinding
import com.czf.dji.models.SecurityCodeVM
...
class SecurityCodeFragment : DJIFragment() {
    ...
    private lateinit var binding: FragSecurityCodePageBinding

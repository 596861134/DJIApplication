...
import com.czf.dji.databinding.FragPayloadDataPageBinding
import com.czf.dji.models.PayLoadDataVM
...
class PayLoadDataFragment : DJIFragment() {
    ...
    private lateinit var binding: FragPayloadDataPageBinding

...
import com.czf.dji.databinding.VideoPlayPageBinding
import com.czf.dji.models.VideoPlayVM
...
class VideoPlayFragment : DJIFragment(), SurfaceHolder.Callback, View.OnClickListener {
    ...
    private lateinit var binding: VideoPlayPageBinding
...
//            })
    ...
    private fun operateSeekBar() {
        ...
        binding.duration?.setText(videoPlayVM.showTime(time))

...
import com.czf.dji.data.FlightControlState
import com.czf.dji.data.MissionUploadStateInfo
        ...
        return if (isGoogleMapsSupported()) {
            ArrayAdapter<String>(
                ...
                ContextUtil.getContext().resources.getStringArray(
                    com.czf.dji.R.array.maps_array_all
                )
            )
        } else {
            ArrayAdapter<String>(
                ...
                R.layout.simple_spinner_dropdown_item,
                ContextUtil.getContext().resources.getStringArray(
                    com.czf.dji.R.array.maps_array
                )
            )
        }
    }

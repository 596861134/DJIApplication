...
import com.czf.dji.data.source.VersionInfo
import com.czf.dji.databinding.LayoutVersionInfoBinding
import com.czf.dji.models.VersionInfoVm
...
class VersionInfoView @JvmOverloads constructor(
    ...
    private var binding: LayoutVersionInfoBinding

    init {
        val inflater = LayoutInflater.from(context)
        binding = LayoutVersionInfoBinding.inflate(inflater, this)
    }

...
import dji.v5.ux.databinding.UxsdkFpvPfdSpeedDisplayWidgetBinding
import dji.v5.ux.databinding.UxsdkFpvTopBarWidgetGpsSignalBinding
...
open class DeviceHealthAndStatusWidget @JvmOverloads constructor(
    ...
    override fun initView(context: Context, attrs: AttributeSet?, defStyleAttr: Int) {
        ...
        binding = UxsdkFpvTopBarWidgetWarningMessageBinding.inflate(inflater, this, true)
